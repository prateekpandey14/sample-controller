...
import (
	...
	scheme "github.com/prateekpandey14/sample-controller/pkg/client/clientset/versioned/scheme"
...
func newDatabases(c *OpenebsV1alpha1Client, namespace string) *databases {
	return &databases{
		client: c.RESTClient(),
		ns:     namespace,
	}
