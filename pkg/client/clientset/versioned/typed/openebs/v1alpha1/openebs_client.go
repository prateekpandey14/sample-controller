...
import (
	...
	"github.com/prateekpandey14/sample-controller/pkg/client/clientset/versioned/scheme"
...
func (c *OpenebsV1alpha1Client) Databases(namespace string) DatabaseInterface {
